...
#import "CDSwipeTransitionDelegate.h"
#import "CDSwipeTransitionAnimator.h"
#import "CDSwipeTransitionInteractionController.h"

@implementation CDSwipeTransitionDelegate
...
{
    return [[CDSwipeTransitionAnimator alloc] initWithTargetEdge:self.targetEdge];
}
...
- (id<UIViewControllerInteractiveTransitioning>)interactionControllerForPresentation:(id<UIViewControllerAnimatedTransitioning>)animator
{
    ...
    if (self.gestureRecognizer)
        return [[CDSwipeTransitionInteractionController alloc] initWithGestureRecognizer:self.gestureRecognizer edgeForDragging:self.targetEdge];
    else
        return nil;
}
